...
**The qualification gate applies to Tier 2 only.** Tier 1 advertising — buy alert sponsorships, standard trending slots, weekly promos — has no qualification. Anyone can buy. We label it clearly. We do not endorse it.
